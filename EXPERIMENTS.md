...
| 9 | [9-scale-free-mining.md](experiments/9-scale-free-mining.md) | miners.py | can the proposal map be made scale-free with acceptance unchanged? M1 covariance (anchors) vs M2 whitened (the invariance repair, FORMALISM.md §5 proposition asserted numerically) vs M3 centered-weight (decorrelation, ~50% credence), both regimes; completes exp-8's P4 matrix | P1/P7 hold; P2/P3/P6 fail; P4 still NOT TESTED. The invariance proposition is *confirmed* (probe exact; identical trajectories; κ-fingerprint) and the repair fails anyway — **in both regimes**: whitening flattens the spectrum that made selection sharp; channel and echo are correlationally identical, so invariant correlational mining has no signal left. M1's success was variance luck (triply confirmed); M3 works benignly (95.5%, second benign miner) but dies adversarially. Proposals must become interventional → exp 10 | concluded |
