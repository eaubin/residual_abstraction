...
| 6 | [6-interventional-discovery.md](experiments/6-interventional-discovery.md) | discover.py | can a CEGAR loop scored by *observable* interchange closure at L1 discover a low-dim causal abstraction approaching full-patch closure, avoiding the PLS echo failure — without trivially growing k? | pre-registered P1–P7 (anti-triviality: marginal-gain stop, k_max-as-failure, joint small-k+high-closure success bar) | pre-registered, not run |
