...
| 20 | [20-dyck-matrix.md](experiments/20-dyck-matrix.md) | dyck_matrix.py | Interventional battery matrix (Phase 2, Block 2): adversarial regime (κ=100), shift-retention (member 4), depth stratification, gradient read probe | — | pre-registered |
