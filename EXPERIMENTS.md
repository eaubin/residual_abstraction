...
| 23 | [23-oracle-substrate.md](experiments/23-oracle-substrate.md) | scripts/oracle_withdrawal/substrate.py | Oracle-withdrawal 1: is the `pstack` measurement substrate competent, affordable, sampled-calibrated, stratified, and non-vacuous enough for hidden-oracle reference selection? | — | pre-registered |
