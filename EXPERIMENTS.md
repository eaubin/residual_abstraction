...
| 19 | [19-dyck-baseline.md](experiments/19-dyck-baseline.md) | dyck_baseline.py | Dyck baseline + threshold recalibration (Phase 2, Block 1): does the frozen battery produce coherent numbers on Dyck-2, and what are the process-appropriate thresholds? | — | pre-registered |
