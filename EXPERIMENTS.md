...
| 20 | [20-dyck-matrix.md](experiments/20-dyck-matrix.md) | dyck_matrix.py | Interventional battery matrix (Phase 2, Block 2): adversarial regime (κ=100), shift-retention (member 4), depth stratification, gradient read probe | **P1–P6 all hold** — adversarially opaque (accept=0, ρ 70×), fully distribution-robust (retention ≥ 0.99 both shifts), depth-uniform (1.9% spread across prefix-balance strata), single-write rank-1 probe fails at 19.7% (P7 finding, not battery failure); P1–P6 battery gates transfer unchanged; Block 2 gates passed | concluded |
