...
| 10 | [10-interventional-search.md](experiments/10-interventional-search.md) | candidates.py | finite-candidate interventional search: 12-candidate pools from cheap fallible sources (incl. the exp-9 losers), ranked by *measured closure gain under patching*, acceptance unchanged, uniform working-coordinate patch convention judged after pullback; adjudicates selection-works / support-or-patch-failure / mere-reranking via registered per-candidate gain+angle tables; gradients deferred to exp 11 | pre-registered P1–P6 (P3 headline at ~60% declared credence; P4/P5 three-way) | pre-registered, not run |
