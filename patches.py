...
prec +1.4% on the same write; high read-junk is necessary for
destruction, not sufficient) but transfer weak — best adversarial gain
+4.5% (0.5 points under eps_gain 5.0%; loop stopped honestly), and prec
under-transfers even benignly (+16.1% vs id's +54.3%, read-junk 3% vs 0%):
GLS junk-safety controls away signal. The registered ridge-gap
